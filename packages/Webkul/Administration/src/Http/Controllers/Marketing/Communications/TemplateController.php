...
namespace Webkul\Administration\Http\Controllers\Marketing\Communications;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Webkul\Administration\DataGrids\Marketing\Communications\EmailTemplateDataGrid;
