...
namespace Webkul\Administration\Http\Controllers\Customers;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Mail;
use Webkul\Administration\DataGrids\Customers\CustomerDataGrid;
use Webkul\Administration\DataGrids\Customers\View\InvoicesDatagrid;
use Webkul\Administration\DataGrids\Customers\View\OrdersDataGrid;
use Webkul\Administration\DataGrids\Customers\View\ReviewDatagrid;
use Webkul\Administration\Http\Controllers\Controller;
use Webkul\Administration\Http\Requests\MassDestroyRequest;
use Webkul\Administration\Http\Requests\MassUpdateRequest;
use Webkul\Administration\Mail\Customer\NewCustomerNotification;
