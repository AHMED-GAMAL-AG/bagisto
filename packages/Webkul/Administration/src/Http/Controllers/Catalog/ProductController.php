...
namespace Webkul\Administration\Http\Controllers\Catalog;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use Webkul\Administration\DataGrids\Catalog\ProductDataGrid;
use Webkul\Administration\Http\Controllers\Controller;
use Webkul\Administration\Http\Requests\InventoryRequest;
use Webkul\Administration\Http\Requests\MassDestroyRequest;
use Webkul\Administration\Http\Requests\MassUpdateRequest;
use Webkul\Administration\Http\Requests\ProductForm;
use Webkul\Administration\Http\Resources\AttributeResource;
use Webkul\Administration\Http\Resources\ProductResource;
